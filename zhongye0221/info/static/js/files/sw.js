...
function sw_chaxun() {
    ...
    var data_id = $('.sw_ziliaoID').val();
    var data_source = $('.sw_srouce').val();
    var province = $('.sw_province').val();
    var city = $('.sw_city').val();
    var sw_pro = $('.sw_pro').val();
        ...
        success: function (data) {
            ...
            $('#table_result').bootstrapTable({
                ...
                var temp = {
                    ...
                    data_id : $('.sw_ziliaoID').val(),
                    data_source : data_source,
                    province : $('.sw_province').val(),
                    city : $('.sw_city').val(),
                    sw_pro : $('.sw_pro').val(),
                    status :$('.sw_status').val(),
                    save_time : $('.ui-datepicker-time').val(),
